...
from splearn.data import MultipleSubjects, JFPM, PyTorchDataset, PyTorchDataset2Views
...
from splearn.nn.models import MultitaskSSVEPClassifier, SSLClassifier

config = {
    "experiment_name": "siamese_multitask_jfpm",
    "data": {
...
def train_test_subject(data, config, test_subject_id, kfold_k=0):
    ...
    base_model = MultitaskSSVEPClassifier(num_channel=num_channel, num_classes=num_classes, signal_length=signal_length)
